...
| Local template reference | Use `bevy/crates/template-crate` as the proper project-owned reference for Bevy crate folders, representative files, asset folders, and Rust coding standards. |
...
- Check `bevy/crates/template-crate` before creating new Bevy folders or representative Rust files in this repository.

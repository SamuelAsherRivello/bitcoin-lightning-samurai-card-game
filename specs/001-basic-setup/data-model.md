...
| Project Script | Build, test, run, desktop run, stop, and dependency-check entry points under root `scripts` | Used by VS Code tasks and manual terminal workflows | Must run from repository root |

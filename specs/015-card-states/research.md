...
| Opponent reveal | `PlacementVisibilityModel` | `CurrentRoundHidden`, `Revealed` | This is gameplay knowledge/reveal state, separate from front/back layer mechanics. |
...
| Zone detail | Zone-specific references | Deck index, hand order, location/side/slot, same-round movable/locked |
| Visibility policy | What a viewer/controller may know | Owner visible, current-round hidden to opponent, revealed |

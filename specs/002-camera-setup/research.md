...
| Keep the camera fixed and input-free | The feature explicitly excludes orbit, pan, zoom, and gameplay input, and later card presentation should own interaction behavior | Adding camera controls now would make DebugHUD and card presentation tests less predictable |

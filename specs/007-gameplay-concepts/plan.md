...
| Gate | Status | Notes |
| ---- | ------ | ----- |
| No unresolved clarifications | ✅ | The spec resolves button placement, round schedule, energy schedule, deck composition, every-round deck-to-hand deal selection, undo scope, same-round placed-card mobility, prior-round placed-card locking, restart behavior, location open rounds, location text, and the initial location effective-energy abilities |

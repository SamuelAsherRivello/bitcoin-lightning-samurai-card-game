...
| ------------- | ----------- |
| Default size | The desktop window opens at 800x600 when no valid placement exists |
...
| Invalid/off-screen fallback | The app opens centered on the primary screen at 800x600 |

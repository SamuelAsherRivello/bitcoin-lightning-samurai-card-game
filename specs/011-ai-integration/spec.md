...
| `AppScene` and active views are distinct. | `AppScene` is always-present while `GameScene`, `DeckScene`, `DebugScene`, or future views represent the active user-facing scene/view state. |

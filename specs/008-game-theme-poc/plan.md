...
**Performance Goals**: Game scene and Card Browser remain responsive during card tilt, flip animation, world swaps, and card navigation; asset count remains bounded to the four cards, two worlds, and six reusable tactical locations  
...
**Scale/Scope**: Four bottom cards, two world backgrounds, six reusable location identities, three visible locations per world swap, one focused Card Browser card at a time
...
| Visible feedback preserved | PASS | Feature does not change template loading/database workflows; Card Browser and scene transitions remain visibly immediate. |

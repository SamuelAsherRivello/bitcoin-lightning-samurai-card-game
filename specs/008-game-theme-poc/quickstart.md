...
| Click Kage Ren, Lord Daichi, Sister Hotaru, and Yokai placeholder | Deck opens focused on the clicked card. |
| Press `T` in Deck | Global CardUI settings change without changing the GameScene world. |
